class Email
    ...
    body << "<p>Your account email address is: #{email}</p>"
		...
		if policy == 'ceu'
			body << "<p>The customer has 3 days from the purchase date to review the purchased <em>online services,</em> including online Scenarios, to confirm that it is what he or she expected. If unhappy with the content for any reason, the customer is required to notify CTC within these 3 days either by phone or e-mail that he/she is requesting. Further, to qualify for a refund, the customer <em>may not have accessed more than 1 online scenario</em>. Upon proper notification, CTC will turn off access to these online services, and a refund will be issued.</p>"
		end
