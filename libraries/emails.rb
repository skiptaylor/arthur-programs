class Email
	...
	def self.welcome to, name, email, policy
		...
		body << "<p><strong>NOTE:</strong> You are responsible for maintaining the confidentiality of the log-in credentials and are solely responsible for all activities that occur under your account. Your account is ONLY FOR PERSONAL USE. You may NOT authorize others to use the account, and you may NOT assign or otherwise transfer the account to any other person or entity. You agree to safeguard the login information used to access this site. You agree not to disclose or share your login information with any third party. You authorize DGA/CTC to assume that any user accessing the site with your log-in credentials is you, the authorized user.</p>"
